        ...
        return (
          ...
          >
            <Progress.Label mb="2">
              ...
              <InfoTip>
                We're collecting your missing blobs from your origin PDS, this might take a while
              </InfoTip>
            </Progress.Label>
            <Progress.Track>
              <Progress.Range />
        ...
        return (
          ...
          >
            <Progress.Label mb="2">
              ...
              <InfoTip>
                We're importing your missing blobs to Northsky, this might take a while
              </InfoTip>
            </Progress.Label>
            <Progress.Track>
              <Progress.Range />
  ...
  useEffect(() => {
    (async () => {
      if (
        fetcher.state === "idle" &&
        !error &&
        [STAGES.MISSING_BLOBS_EXPORT, STAGES.MISSING_BLOBS_IMPORT].includes(stage)
      ) {
        setTimeout(async () => {
    ...
    <fetcher.Form method="post" style={{ width: "100%" }}>
      <VStack mb="5" width="100%">
        ...
        >
          ...
          <Progress.Root width="100%" max={2} min={0} value={stageIdx} striped animated>
            <Progress.Label mb="2">
          ...
          {error && (
            <>
              <Text fontSize="md" color="red.500" textAlign="center">
                An error occurred while recovering your blobs. Please try again or contact support
